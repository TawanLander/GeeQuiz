...
function esconderSenha() {
  if (ocultado) {
    ...
    document.getElementById("bd-senha").innerHTML = informacoes.senha;
    // ? INVERTE A BOOLEANA
    ocultado = false;
  } else {
    path.setAttribute(
...
async function pegarQuizesCompletos() {
  ...
  let msg =
    '<div class="parte"><h1>Seu histórico de quizes!</h1><div class="quizes">';
...
async function ativarInputs() {
  ...
  let data = document.getElementById("ipt-dtNascimento");
  let outroGenero = document.getElementById("ipt-outroGenero");
  let email = document.getElementById("ipt-email");
  let senha = document.getElementById("ipt-senha");
